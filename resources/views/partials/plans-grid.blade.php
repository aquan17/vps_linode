        ...
        <div class="p-6 flex-1 flex flex-col">
            ...
            <ul class="space-y-4 mb-8">
                ...
                <li class="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span class="font-semibold text-gray-900">{{ $plan['transfer_tb'] ?? 1 }} TB</span> Transfer
                </li>
                <li class="flex items-center gap-3 text-sm text-gray-600">
                    ...
                    <span class="font-semibold text-gray-900">40 Gbps / {{ $plan['network_out_mbps'] ?? 1000 }} Mbps</span>
                </li>
            </ul>
